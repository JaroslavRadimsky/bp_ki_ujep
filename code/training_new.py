"""Alternative training entry points shared by atlas segmentation scripts.

This module mirrors :mod:`training` so scripts that historically imported
``training_new`` continue to work without code changes.
"""
