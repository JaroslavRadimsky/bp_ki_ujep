...
Shim et al. roku 2022 aplikovali U-Net a jeho modifikace na segmentaci krčních obratlů a lebečních kostí na rentgenových snímcích, přičemž dosáhli přesnosti kolem 99~\% a hodnoty Dice (vzorec~\ref{eq:dice}) koeficientu okolo 0,89 \cite{Shim2022}.
...
\begin{itemize}
  \item Funkce \texttt{approx\_quad} hledá čtyřúhelníkové přiblížení kontury pomocí polygonální aproximace. Pokud polygonální aproximace selže, postupuje se alternativně přes metodu \texttt{cv2.minAreaRect}, která vrací nejmenší obdelník obsahující celou plochu obratle.
